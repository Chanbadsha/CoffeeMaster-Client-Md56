...
const AddCoffee = () => {
    ...
    const handleAddCoffeeDetail = e => {
        ...
        const coffeeData = { coffeeName, chefName, supplier, price, category, details, photoUrl }
        console.log(coffeeData);


        // Save to MongoDB
        fetch("http://localhost:5000/addcoffeedetail", {
            method: "POST",
            headers: {
      ...
      <div className="hero bg-base-200  text-[#331A15] ">
        <div className="hero-content flex-col justify-center items-center">
          ...
          <div className="card bg-base-100 w-full max-w-5xl mx-auto  shrink-0 shadow-2xl">
            <form
              onSubmit={handleAddCoffeeDetail}
